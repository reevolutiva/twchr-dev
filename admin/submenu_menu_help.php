...
<div class="twchr-for-back-broadcast container">
	...
	<form action="./edit.php" method="get">
		...
		<label>
			on
			<input type="radio" name="twchr_set_clear_tw" value="1" <?php echo $delete_all !== false && $delete_all == 1 ? 'checked' : ''; ?>>
		</label>
		<label>
			off
			<input type="radio" name="twchr_set_clear_tw" value="0" <?php echo $delete_all !== false && $delete_all == 0 ? 'checked' : ''; ?>>
		</label>
