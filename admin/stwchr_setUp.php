...
<div class="twchr_settUp_overlay">
	<div id='twchr-setUp'>
		...
		<section class="card-section">
			<h3>1</h3>
			<h4><?php _e('Go to ','twitcher');?><a target="new_black" href="https://dev.twitch.tv/console/apps/create"><?php echo  __('Twitch Developers Console App Creation (click here)','twitcher'); ?></a></h4>
			<p>(Twitch credentials required).</p>
			<img src="<?php echo  plugins_url('/twitcher/admin/setUp-img/setUp-image-1.jpg') ?>" alt="">
		</section>
		<section class="card-section">
			<h3>2</h3>
			<h4><?php _e('Set a name for your app (could be your Wordpress site name). ','twitcher');?></h4>
			<img src="<?php echo  plugins_url('/twitcher/admin/setUp-img/setUp-image-2.jpg') ?>" alt="">
		</section>
		<section class="card-section">
			<h3>3</h3>
			...
			<img src="<?php echo  plugins_url('/twitcher/admin/setUp-img/setUp-image-3.jpg') ?>" alt="">
		</section>
		<section class="card-section">
			<h3>4</h3>
			<h4><?php _e('Go to Cateogory and select “Others”, then resolve the captcha and press “Create”','twitcher');?></h4>
			<img src="<?php echo  plugins_url('/twitcher/admin/setUp-img/setUp-image-4.jpg') ?>" alt="">
		</section>
		<section class="card-section form">
			...
			<form method='GET' action='https://<?php echo $_SERVER['SERVER_NAME']?>/wp-admin/edit.php'>
...
<?php 
	if(isset($_GET['error'])){
		?>
			<script>
				alert("Ups! Error: <?php echo $_GET['error']?>");
			</script>
		<?php
	}
?>